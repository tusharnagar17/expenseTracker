import { View, Text, SafeAreaView,Alert, StyleSheet, TextInput, TouchableHighlight, TouchableOpacity } from 'react-native'
  ...
  return (
    <SafeAreaView style={{marginTop: 60, flex:1, justifyContent: "center",  padding:16 }}>
        <View style={styles.loginContainer}>
            <View><Text style={{fontSize: 40, fontWeight: "500", textAlign: "center"}}>Forgot Password</Text></View>

            <View><Text style={{fontSize: 16, fontWeight: "400", paddingVertical: 20, textAlign: "center"}}>Please enter your email address to receive a verification code!</Text></View>
            ...
            <TouchableHighlight underlayColor="transparent" style={styles.formBtnWrapper} onPress={ForgotPasswordBtnClicked}>
